function [trainedClassifier, validationAccuracy] = quadraticclassifier(trainingData)
...
% Auto-generated by MATLAB on 14-Oct-2022 18:44:46
...
figure;
plot(trainingData(:,1),trainingData(:,2),'ro','MarkerFaceColor','b','MarkerEdgeColor','k');
hold on;
plot(trainingData(classificationSVM.IsSupportVector,1),trainingData(classificationSVM.IsSupportVector,2),'o','MarkerFaceColor','r','MarkerEdgeColor','k');

title('feature data along with support vectors');
hold off;
% Extract predictors and response
% This code processes the data into the right shape for training the
% model.
